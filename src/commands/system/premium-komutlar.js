  ...
  async execute(interaction) {
    ...
    if (!proCommands.length) {
      await interaction.reply({
        content: '💤 Şu anda pro etiketi taşıyan komut bulunmuyor. Bot sahibi yeni komutlar eklediğinde liste güncellenecek.',
        ephemeral: true
      });
      return;
    }
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription('Aşağıdaki liste, Pro üyelerin kullanımına açık slash ve önek komutları içerir.')
